...
use crate::ui::widgets::{
    FloatingPanel, PanelContainer, PanelBody, HeaderRow, HamburgerButton,
    CheckboxRow, CheckboxButton, CheckboxSetting, CheckboxIcon, ImportButton, ExportButton,
};
...
fn spawn_icon_text_button<C: Component>(
    parent: &mut ChildSpawnerCommands,
    icon: Handle<Image>,
    text: &str,
    marker: C,
